"""
Django settings for tasker_jolita project.
...
SECRET_KEY = 'django-insecure-s^o8*m55m8g25#j534*as-#_y!%*jbb9p*7b*f081-o2w=o-&f'
...
ROOT_URLCONF = 'tasker_jolita.urls'
...
WSGI_APPLICATION = 'tasker_jolita.wsgi.application'
